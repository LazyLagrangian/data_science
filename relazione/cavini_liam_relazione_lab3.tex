...
\begin{figure}[H]
    ...
    \begin{subfigure}{.49\textwidth}
     ...
     \end{subfigure}
    \caption{\emph{Due fit dei dati generati, il grafico a sinistra mostra il fit con parametri $\alpha = 100$ e $n = 10$, il grafico di destra con parametri $n = 18$ e $a = 0.01$. Il primo di questi risulta essere un buon fit, mentre il secondo non predice correttamente i dati di test.}}
    \label{fig:fits_ex1}
\end{figure}
